...
const AboutApp = () => {
  return (
    <div className="space-y-6 text-gray-900">
      <div>
        <h2 className="text-xl sm:text-2xl font-extrabold tracking-tight">About AutoFlow Ops</h2>
      ...
      <div className="bg-white border border-gray-200/90 rounded-3xl p-6 shadow-2xs space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-lg font-extrabold text-gray-900">AutoFlow Ops Platform</h3>
