          ...
          <div className="col-span-4 space-y-4">
            ...
            <div className="bg-white border border-gray-200/90 rounded-3xl p-5 shadow-2xs flex items-center gap-3.5">
              ...
              <div className="min-w-0">
                <h3 className="text-base font-extrabold text-gray-900 truncate">Elite Wash Co.</h3>
                <p className="text-xs text-gray-500 font-semibold truncate">Sarah Jenkins</p>
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-600">Sarah Jenkins</p>
