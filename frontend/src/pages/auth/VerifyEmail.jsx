...
export default function VerifyEmail() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await verifyEmail({ email: emailInput, otp: fullOtp });
      if (res && res.success) {
  ...
  const handleResendCode = async () => {
    ...
    if (!emailInput) {
      setErrorMessage('Please provide your email address to resend code.');
      return;
    }
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-5/12 bg-[#F4F4F6] relative overflow-hidden flex-col justify-between p-12 xl:p-16 select-none">
        ...
        <div className="relative z-10 flex flex-col gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-2 max-w-sm leading-relaxed">
              We've sent a 6-digit security code to your email. Enter it below to activate your workshop workspace.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-4 pt-8">
          <div className="flex items-center gap-3 text-xs font-semibold text-gray-700 bg-white/80 backdrop-blur-xs p-3.5 rounded-2xl border border-gray-200/60 shadow-xs">
            ...
            <span>Cryptographically secured Email OTP protection</span>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-10 lg:p-16 xl:p-24 overflow-y-auto">
        <div className="max-w-md w-full mx-auto my-auto space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-gray-700">Verification Code</label>
        ...
        <div className="text-center text-xs text-gray-400 pt-8">
          <span>Having trouble? Contact </span>
          <span className="text-gray-700 font-semibold cursor-pointer">SparklePro Support</span>
        </div>
      </div>
    </div>
  );
